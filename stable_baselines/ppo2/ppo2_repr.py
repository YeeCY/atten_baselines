    ...
    def setup_model(self):
        with SetVerbosity(self.verbose):
            ...
            with self.graph.as_default():
                ...
                with tf.variable_scope("postive_model", reuse=True,
                                       custom_getter=tf_util.outer_scope_getter("positive_model")):
                    positive_model = self.policy(self.sess, self.observation_space, self.action_space,
                                              self.n_envs // self.nminibatches, self.n_steps, n_batch_train,
                                              reuse=True, **self.policy_kwargs)
                with tf.variable_scope("negative_model", reuse=True,
                                       custom_getter=   tf_util.outer_scope_getter("negative_model")):
                ...
                with tf.variable_scope("target_model", reuse=True,
                                       custom_getter=   tf_util.outer_scope_getter("target_model")):
                ...
                with tf.variable_scope("loss", reuse=False):
                    ...
                    emb_cur = target_model.latent
                    emb_next = positive_model.latent
                    emb_neq = negative_model.latent

                    self.contrastive_loss = self.contrastive_loss_fc(emb_cur, emb_next, emb_neq, c_type=c_loss_type)
